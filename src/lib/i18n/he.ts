export const he = {
  ...
  auth: {
    ...
    loginLink: 'התחבר כאן',
    /** כניסה מהירה — נוצר משתמש אורח אחד משותף לדמו */
    continueAsGuest: 'המשך כאורח (בלי מייל)',
    guestHint: 'חשבון אורח משותף לדמו. כדי לשמור נתונים רק שלך — התחבר עם האימייל שלך.',
